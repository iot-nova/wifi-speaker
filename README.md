...
## DESCRIPTION
Wifi-Speaker lets you upload a script on your microcontroller which allows you to play musics from the web via HTTP streaming.
...
1 - Set any MP3 HTTP URL in the Main.ino file.

2 - Upload the sketch to your microcontroller and wait for its completion.

3 - Open the Serial Monitor to monitor outputs.

4 - Wait for the music to play by itself.
